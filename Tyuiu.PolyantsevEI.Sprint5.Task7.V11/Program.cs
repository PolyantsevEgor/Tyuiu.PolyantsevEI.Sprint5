...
using System.IO;
using Tyuiu.PolyantsevEI.Sprint5.Task7.V11.Lib;

namespace Tyuiu.PolyantsevEI.Sprint5.Task7.V11
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Удалить все строчные русские буквы из файла.                            *");
